...
namespace Ciribob.DCS.SimpleRadio.Standalone.Client.Overlord.GameState
{
    ...
    {
        public static async Task<Dictionary<string, int>> GetBearingToNamedAirbase(Geo.Geometries.Point callerPosition, string group, int flight, int plane, string airbase)
        {
